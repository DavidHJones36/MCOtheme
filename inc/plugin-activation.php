...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
			...
			'source'   => get_stylesheet_directory() . '/inc/meta-box-show-hide.zip', // The plugin source.
        ...
        array(
			...
			'source'   => get_stylesheet_directory() . '/inc/meta-box-conditional-logic.zip', // The plugin source.
			'required' => true, // If false, the plugin is only 'recommended' instead of required.
		),
        array(
			'name'     => 'Meta Box Group', // The plugin name.
			'slug'     => 'meta-box-group', // The plugin slug (typically the folder name).
			'source'   => get_stylesheet_directory() . '/inc/meta-box-group.zip', // The plugin source.
			'required' => true, // If false, the plugin is only 'recommended' instead of required.
		),
        array(
			'name'     => 'Meta Box Columns', // The plugin name.
			'slug'     => 'meta-box-columns', // The plugin slug (typically the folder name).
			'source'   => get_stylesheet_directory() . '/inc/meta-box-columns.zip', // The plugin source.
			'required' => true, // If false, the plugin is only 'recommended' instead of required.
		),
        array(
			'name'     => 'Meta Box Updater', // The plugin name.
			'slug'     => 'meta-box-updater', // The plugin slug (typically the folder name).
			'source'   => get_stylesheet_directory() . '/inc/meta-box-updater.zip', // The plugin source.
			'required' => true, // If false, the plugin is only 'recommended' instead of required.
		),
        array(
